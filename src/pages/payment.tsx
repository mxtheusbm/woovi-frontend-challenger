            ...
            label={
              <Box>
                <Typography variant="h5" fontWeight="600">
                  <Typography display="inline" variant="h5" fontWeight="800">
                    1x
                  </Typography>{' '}
                  R$ {formatNumberToBR(data.value)}
                </Typography>

                <Typography color="primary" fontWeight="600">
                  Ganhe{' '}
                  <Typography color="primary" display="inline" fontWeight="800">
                    3%
                  </Typography>{' '}
                  de Cashback
                </Typography>
                ...
                <Banner>
                  <Box>
                    <Typography color="white" variant="body2" fontWeight="600">
                      🤑{' '}
                      <Typography display="inline" color="white" variant="body2" fontWeight="800">
                        R$ 300,00
                      </Typography>{' '}
                      de volta no seu Pix na hora
                    </Typography>
                    <div
                      className={`ribbon ${selectedPaymentMethod == data.value.toString() ? 'ribbon-active' : ''}`}></div>
                  </Box>
                </Banner>
              </Box>
            }
                  ...
                  label={
                    <div style={{ width: '100%' }}>
                      <Typography variant="h5" fontWeight="600">
                        ...
                        R$ {formatNumberToBR(installment.value / installment.number)}
                      </Typography>
                      <Typography color="info.200">
                        Total: R$ {formatNumberToBR(installment.value)}
                      </Typography>
                    </div>
                  }
                  selectedValue={selectedPaymentMethod}
